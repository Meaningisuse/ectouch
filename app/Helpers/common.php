...
function shop_config()
{
    ...
    if ($data === false) {
        ...
        if (empty($arr['integrate_code']) || $arr['integrate_code'] == 'ectouch') {
            $arr['integrate_code'] = 'passport'; // 默认的会员整合插件
        }
...
function price_format($price, $change_price = true)
{
    ...
    if ($change_price && defined('ECT_ADMIN') === false) {
