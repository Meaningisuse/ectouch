...
<span class="text">in <?php echo $e['file'] ;?></span>
<span class="at">at line <span class="line"><?php echo $e['line'];?></span></span>
</div>
</div>
<?php }?>
<?php
if(isset($e['trace'])) {
$trace = explode("\n", $e['trace']);
foreach($trace as $key => $file){
$pattern = '/\#(\d+) (.*)/i';
$replacement = '$2';
$file = preg_replace($pattern, $replacement, $file);
?>
<li class="call-stack-item" data-line="0">
<div class="element-wrap">
<div class="element">
<span class="item-number"><?php echo $key + 2;?>.</span>
<span class="text"><?php echo $file;?></span>
<span class="at"><span class="line"></span></span>
</div>
</div>
</li>
<?php }}?>
...
<div class="request">
    <div class="code">
        <?php
                ...
                $request = '';
                foreach ($displayVars as $name) {
                    if (!empty($GLOBALS[$name])) {
                        $request .= '$' . $name . ' = ' . var_export($GLOBALS[$name], 1) . ";\n\n";
                    }
                }
                echo '<pre>' . rtrim($request, "\n") . '</pre>';
        ?>
    </div>
</div>
...
<div class="footer">
    ...
    <p>Powered by <a href="http://ectouch.cn/">ECTouch</a></p>
</div>
...
<?php }else{ ?>
    <div class="notfound"><a href="<?php echo __ROOT__;?>">Error</a></div>
<?php } ?>
</body>
</html>
