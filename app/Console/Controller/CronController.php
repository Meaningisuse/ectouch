...
class CronController extends InitController
{
    public function index()
    {
        ...
        admin_priv('cron');
        $exc = new Exchange($GLOBALS['ecs']->table('crons'), $this->db, 'cron_code', 'cron_name');
    ...
    protected function get_next_time($cron)
    {
        $timestamp = gmtime();
    ...
    protected function get_minute($cron_minute)
    {
