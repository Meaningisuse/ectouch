...
class ConvertController extends InitController
{
     ...
     */
    protected function check_files_readable($dirname)
    {
        /* 遍历文件，检查文件是否可读 */
     ...
     */
    protected function copy_files($from_dir, $to_dir, $file_prefix = '')
    {
        /* 遍历并复制文件 */
     ...
     * @return  mix     成功返回true，否则返回第一个失败的文件名
     */
    protected function copy_dirs($from_dir, $to_dir, $file_prefix = '')
    {
        $result = true;
        if (!is_dir($from_dir)) {
            die("It's not a dir");
