...
class DatabaseController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'backup') {
            ...
            return $this->smarty->display('db_backup.htm');
        }
        ...
        if ($_REQUEST['act'] == 'restore') {
            ...
            return $this->smarty->display('db_restore.htm');
        }
        ...
        if ($_REQUEST['act'] == 'dumpsql') {
            ...
            if (empty($tables)) {
                ...
                if ($vol > 1) {
                    ...
                    return $this->smarty->display('sql_dump_msg.htm');
                } else {
                    /* 只有一个文件 */
        ...
        if ($_REQUEST['act'] == 'optimize') {
            ...
            $db_ver = $db_ver_arr;
            $ret = $db->query("SHOW TABLE STATUS LIKE '" . mysql_like_quote($GLOBALS['ecs']->prefix) . "%'");
            ...
            return $this->smarty->display('optimize.htm');
        }
