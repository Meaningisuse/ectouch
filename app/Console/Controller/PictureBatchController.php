...
class PictureBatchController extends InitController
{
     ...
     * @return void
     */
    protected function process_image($page = 1, $page_size = 100, $type = 0, $thumb = true, $watermark = true, $change = false, $silent = true)
    {
        if ($type == 0) {
     ...
     * @return void
     */
    protected function process_image_ex($page = 1, $page_size = 100, $type = 0, $thumb = true, $watermark = true, $change = false, $silent = true)
    {
        if ($type == 0) {
     ...
     * @return void
     */
    protected function replace_image($new_image, $old_image, $goods_id, $silent)
    {
        $error = false;
