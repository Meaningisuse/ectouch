...
class EditLanguagesController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('language_list.htm');
        }
     ...
     */
    protected function get_language_item_list($file_path, $keyword)
    {
        if (empty($keyword)) {
            return [];
        }
     ...
     */
    protected function set_language_items($file_path, $src_items, $dst_items)
    {
        /* 检查文件是否可写（修改） */
