...
class FlashplayController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            return $this->smarty->display('flashplay_list.htm');
        }
        if ($_REQUEST['act'] == 'del') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            if (empty($_POST['step'])) {
                ...
                return $this->smarty->display('flashplay_add.htm');
            } elseif ($_POST['step'] == 2) {
...
//        }
            ...
            return $this->smarty->display('flashplay_custom.htm');
        }
...
//        }
            ...
            return $this->smarty->display('flashplay_custom_add.htm');
        }
        ...
        if ($_REQUEST['act'] == 'custom_status') {
            ...
            if ($this->modfiy_ad_status($id, $ad_status)) {
                ...
                return make_json_result($this->smarty->fetch('flashplay_custom.htm'));
            } else {
                return make_json_error($GLOBALS['_LANG']['edit_no']);
            }
        }
        ...
        if ($_REQUEST['act'] == 'custom_edit') {
            ...
            /* 添加 */
            $this->smarty->assign('ad', $ad);
            return $this->smarty->display('flashplay_ccustom_edit.htm');
        }
