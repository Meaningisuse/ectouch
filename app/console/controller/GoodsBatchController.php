...
//-- 批量修改：修改
        ...
        if ($_REQUEST['act'] == 'edit') {
            ...
            $this->smarty->assign('goods_list', $GLOBALS['db']->getAll($sql));
            ...
            $this->smarty->assign('rank_list', $GLOBALS['db']->getAll($sql));
                    ...
                    foreach ($_POST['goods_id'] AS $goods_id) {
                        ...
                        if (!empty($_POST['product_number'][$goods_id])) {
                            ...
                            foreach ($_POST['product_number'][$goods_id] as $key => $value) {
                                $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('products'), ['product_number', $value], 'UPDATE', "goods_id = '$goods_id' AND product_id = " . $key);
